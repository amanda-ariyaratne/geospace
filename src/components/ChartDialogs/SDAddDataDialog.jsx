...
// components
import FileUploadButton from "./SDFileUploadButton";
...
// redux
import { addRawData } from "../../state/actions/sankeydiagram";
...
export default function SDAddDataDialog(props) {
  ...
  const handleSave = () => {
    ...
    datafile
      ...
      .then((datafile) => {
        ...
        dispatch(addRawData(sankeyDiagram));
        restoreDefaults();
        onClose();
      })
      .catch((err) => {
